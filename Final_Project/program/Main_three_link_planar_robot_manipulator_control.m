...
params.lcm3     = 0.5;      % CM position of link 3 [m]
params.m1       = 50;       % Mass of link 1 [kg]
params.m2       = 50;       % Mass of link 2 [kg]
params.m3       = 50;       % Mass of link 2 [kg]
...
params.kr1      = 100;      % Gear ratio of motor at joint 1 [-]
params.kr2      = 100;      % Gear ratio of motor at joint 2 [-]
params.kr3      = 100;      % Gear ratio of motor at joint 3 [-]
params.m_motor1 = 5;        % Mass of rotor at joint 1 [kg]
params.m_motor2 = 5;        % Mass of rotor at joint 2 [kg]
params.m_motor3 = 5;        % Mass of rotor at joint 3 [kg]
params.I_motor1 = 0.01;     % Moment of inertia of rotor at joing 1 [kg.m^2]
params.I_motor2 = 0.01;     % Moment of inertia of rotor at joing 2 [kg.m^2]
params.I_motor3 = 0.01;     % Moment of inertia of rotor at joing 3 [kg.m^2]
...
Zd1 = z1 + (z2 - z1)/(tspan(end)/2)*[0:Ts:5]';
Zd2 = z2 + (z1 - z2)/(tspan(end)/2)*[0+Ts:Ts:5]';
Zd = [Zd1;Zd2];
...
fun = @(t,X)eom_3DOF_planar_robot_manipulator(t, X, params);
[tout, Xout] = ode45(fun, tspan, X0, params);
