...
%Foward kinematics
[Xdd,Ydd,Zdd] = FK(theta1_d,theta2_d,theta3_d,params);
...
plot3(Xd,Yd,Zd,'LineWidth', 2, 'Color', 'c');
hold on
...
% plot position
subplot(3,5,[4,5])
plot(tspan,Xd, 'LineWidth', 2, 'Color', 'r');
hold on
plot(tspan,Xdd, 'LineWidth', 2,'LineStyle', '--', 'Color', 'k');
xlabel('Time [s]'); ylabel('X [m]');
set(gca, 'FontSize', 8); grid on;title('X position');
legend('Desired Path','Calculated Path')

subplot(3,5,[9,10])
plot(tspan,Yd, 'LineWidth', 2, 'Color', 'g'); 
hold on
plot(tspan,Ydd, 'LineWidth', 2,'LineStyle', '--', 'Color', 'k');
xlabel('Time [s]'); ylabel('Y [m]');
set(gca, 'FontSize', 8); grid on;title('Y position');
legend('Desired Path','Calculated Path')

subplot(3,5,[14,15])
plot(tspan,Zd, 'LineWidth', 2, 'Color', 'b'); 
hold on
plot(tspan,Zdd, 'LineWidth', 2,'LineStyle', '--', 'Color', 'k');
...
subplot(3,1,3)
plot(tspan,theta3_d*180/pi, 'LineWidth', 2, 'Color', 'b'); xlabel('Time [s]'); ylabel('theta3 [deg]');
...
fun_fb = @(t,X)Neom_3DOF_planar_robot_manipulator_feedback(t, X, tspan, params, Xd, Yd, Kinematics_Profiles);
...
[X_fb,Y_fb,Z_fb] = FK(theta1_fb,theta2_fb,theta3_fb,params);
