function X_dot = eom_2DOF_planar_robot_manipulator_feedback(t, X, tspan, params, Xd, Yd, Kinematics_Profiles)
...
r =    [theta1_d_ddot_t;   theta2_d_ddot_t] + ...
    Kd*[theta1_d_dot_t;    theta2_d_dot_t]  + ...
    Kp*[theta1_d_t;        theta2_d_t];

% y = -Kp*[Theta] - Kd*[Theta_dot] + r
y = -Kp*[theta1; theta2] - Kd*[theta1_dot; theta2_dot] + r;
